...
{
    public class TitleConverter_11729 : ITitleConverter
    {
        ...
        public void ConvertJsonToBlf(string jsonFolder, string blfFolder)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                dictionary.Add("/title/default_hoppers/network_configuration_124.bin", BlfFile.ComputeHash(blfFolder + "\\default_hoppers\\network_configuration_124.bin"));
