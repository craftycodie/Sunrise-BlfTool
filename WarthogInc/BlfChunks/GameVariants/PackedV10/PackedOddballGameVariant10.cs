...
{
    public class PackedOddballGameVariant10 : PackedBaseGameVariant10
    {
        public PackedOddballGameVariant10() { }

        public PackedOddballGameVariant10(ref BitStream<StreamByteStream> hoppersStream)
        {
