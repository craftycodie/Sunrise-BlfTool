...
{
    public class PackedJuggernautGameVariant10 : PackedBaseGameVariant10
    {
        public PackedJuggernautGameVariant10() { }

        public PackedJuggernautGameVariant10(ref BitStream<StreamByteStream> hoppersStream)
        {
