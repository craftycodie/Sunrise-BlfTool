...
{
    public class PackedVIPGameVariant10 : PackedBaseGameVariant10
    {
        public PackedVIPGameVariant10() { }

        public PackedVIPGameVariant10(ref BitStream<StreamByteStream> hoppersStream)
        {
