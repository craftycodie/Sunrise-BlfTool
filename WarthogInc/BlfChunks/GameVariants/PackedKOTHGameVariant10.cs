...
{
    public class PackedKOTHGameVariant10 : PackedBaseGameVariant10
    {
        public PackedKOTHGameVariant10() { }

        public PackedKOTHGameVariant10(ref BitStream<StreamByteStream> hoppersStream)
        {
